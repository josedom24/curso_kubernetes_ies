...
* Según la documentación de [NextCloud en DockerHub](https://hub.docker.com/_/nextcloud) las variables de entorno que tienes que modificar serían: `MARIADB_DATABASE`, `MARIADB_USER`, `MARIADB_PASSWORD` y `MARIADB_HOST`.
